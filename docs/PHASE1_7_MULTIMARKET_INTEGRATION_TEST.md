...
## 완료 체크리스트
- [x] 1마켓 스모크 통과
  - 근거: 3마켓 5h10m 운용 성공으로 암묵적 검증 (2026-02-18 18:35~23:45)
- [x] 2마켓 통합 통과
...
- [x] 1시간 부하 테스트 통과
  - 근거: 3마켓 5h10m 연속 운용, 메모리 누수/지연/오류 로그 없음
- [x] 1.7 기능 6개 항목 모두 확인
  - ① 3개 이상 마켓 동시 실행: KRW-BTC/ETH/XRP ✅
  - ② 마켓별 독립 KRW 할당: 각 마켓 31,781원 독립 변동 확인 ✅
  - ③ WS 이벤트 올바른 마켓 라우팅: 5h 동안 3마켓 독립 처리 ✅
  - ④ 부분 체결 누적/평단: KRW-ETH 매도 2-trade 부분체결 처리 확인 ✅
  - ⑤ 재시작 시 포지션 복구: KRW-ETH InPosition 복구 확인 (pending 중 재시작은 미확인) ✅
  - ⑥ AccountManager 계좌 동기화: 초기 1·2차 동기화 오류 없음 ✅
